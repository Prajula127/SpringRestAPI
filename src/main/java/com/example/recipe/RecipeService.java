...
public class RecipeService implements RecipeRepository {
        ...
        public  ArrayList<Recipe> getRecipes() {
                Collection<Recipe> recipeObj = recipeBook.values();
                ArrayList<Recipe> recipe = new ArrayList<>(recipeObj);
                return recipe;
        }
        ...
        public Recipe updateRecipe(int recipeId, Recipe recipe) {
                Recipe rec = recipeBook.get(recipeId);
                ...
                if (recipe.getRecipeType() != null){
                        rec.setRecipeType(recipe.getRecipeType());
                }
